...
def read_root():
    return {
        ...
        "Autor_proyecto": {
            "DataScientist": "Rafael J MIranda G",
...
@app.get(path = '/developer',
          description = """ <font color="blue">
                        ...
                        3. Ir a "Resposes" para ver la cantidad de items y porcentaje de contenido Free por año de ese desarrollador.
                        </font>
...
@app.get (path = '/userdata',
          description = """ <font color="blue">
                        ...
                        3. Ir a a "Resposes" para ver la cantidad de dinero gastado por el usuario, el porcentaje de recomendación que realiza el usuario y cantidad de items que tiene el mismo.
                        </font>
                        """,
         tags=["Consultas Generales"])
...
@app.get(path = "/user_for_genre/", 
        description = """ <font color="blue">
                        ...
                        3. Ir a "Resposes" para ver el usuario que acumula más horas jugadas para el género dado y una lista de la acumulación de horas jugadas por año de lanzamiento.
                        </font>
                        """,
         tags=["Consultas Generales"])
...
@app.get("/best_developer/", 
        description = """ <font color="blue">
                        ...
                        3. Ir a "Resposes" para ver l top 3 de desarrolladores con juegos MÁS recomendados por usuarios para el año dado. (reviews.recommend = True y comentarios positivos)
                        </font>
                        """,
         tags=["Consultas Generales"])
